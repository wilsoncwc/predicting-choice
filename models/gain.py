...
class GAIN(BasicGNN):
    ...
    """
    def init_conv(self, in_channels: int, out_channels: int, batch_norm=True,
                  mlp_num_layers=3, **kwargs) -> MessagePassing:
        mlp = MLP([out_channels for _ in range(mlp_num_layers)], batch_norm=batch_norm)
